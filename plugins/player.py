...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By:- 𝙍𝙘𝙍 𝙊𝙒𝙉𝙀𝙍 (@NAVYA_KESHRI)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**𝑷𝒍𝒆𝒂𝒔𝒆 𝑴𝒂𝒏𝒖𝒂𝒍𝒍𝒚 𝑨𝒅𝒅 𝑨𝒔𝒔𝒊𝒔𝒕𝒂𝒏𝒕 𝒐𝒓 𝑪𝒐𝒏𝒕𝒂𝒄𝒕 :-  @NAVYA_KESHRI** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/60b8861dfd2b06491c8af.jpg"
...
@Client.on_message(commandpro(["/pause", "pause", "mute", "/mute" , "m"]) & other_filters)
@errors
...
@Client.on_message(commandpro(["/resume", "resume", "r" , "continue"]) & other_filters)
@errors
@authorized_users_only
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**𝙍𝙘𝙍・𝙈𝙐𝙎𝙄𝘾 𝑵𝒐𝒘 \n𝑵𝒐𝒕𝒉𝒊𝒏𝒈 𝑷𝒍𝒂𝒚𝒊𝒏𝒈**")
    else:
